...
- this project trains DRL algorithms that will trade in stock markets. it is preferred to use FinRL available from firstly https://github.com/AI4Finance-Foundation/FinRL and secondly https://github.com/AI4Finance-Foundation/FinRL-Meta if the requested functionality is there.
